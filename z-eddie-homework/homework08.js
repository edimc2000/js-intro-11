...
for (let element of arrOfGivens) {
    console.log(`noZero([ ${element.join(', ')} ])`.padEnd(75, ' '), '->', noZero(element));
}
...
for (let element of arrOfGivens) {
    console.log(`numberAndSquare([ ${element.join(', ')} ])`.padEnd(75, ' '), '->', numberAndSquare(element));
}
...
for (let element of arrOfGivens) {
    console.log(`containsValue([ '${element[0].join('\', \'')}' ], '${element[1]}')`.padEnd(75, ' '), '->', containsValue(element[0], element[1]));
}
...
for (let element of arrOfGivens) {
    console.log(`reverseSentence('${element}')`.padEnd(75, ' '), '->', reverseSentence(element));
}
...
for (let element of arrOfGivens) {
    console.log(`removeStringSpecialsDigit('${(element)}')`.padEnd(75, ' '), '->', removeStringSpecialsDigit(element));
}
...
for (let element of arrOfGivens) {
    console.log(`removeArraySpecialsDigits([ ${element.join(', ')} ])`.padEnd(75, ' '), '->', removeArraySpecialsDigits(element));
}
...
for (let element of arrOfGivens) {
    ...
    console.log(`noXInVariables(${JSON.stringify(element)})`.padEnd(maxInputLength + 54), '->', noXInVariables(element));
}